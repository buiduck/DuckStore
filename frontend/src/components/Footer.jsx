    ...
    <footer className=" bg-tertiary max-padd-container text-white py-12 rounded-xl">
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className=" flex flex-col items-center md:items-start">
          ...
          <p className="text-center md:text-left">
            {" "}
            Chào mừng bạn đến với <strong>Shop FusionMart</strong> – Mua sắm
            trực tuyến tiện lợi! Tại đây, chúng tôi mang đến trải nghiệm mua sắm
            hiện đại với hàng ngàn sản phẩm chất lượng, từ thời trang, điện tử
            đến gia dụng và mỹ phẩm. Với giao diện thân thiện, dễ sử dụng, bạn
            có thể tìm kiếm và đặt hàng chỉ trong vài cú click
          </p>
        </div>
      ...
      <div className=" flex flex-col items-center  mt-8">
        ...
        <p className=" text-center text-sm">
          &copy; {new Date().getFullYear()} FusionMart. All Rights Reserved
        </p>
      </div>
    </footer>
  );

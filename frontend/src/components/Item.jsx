  ...
  return (
    <div>
      <Link
        ...
        className=" relative top-28  group bg-white flexCenter m-4
       rounded-2xl ring-1 ring-slate-200/20 hover:shadow-sm"
      >
        <img
          src={product.image}
          alt="productImg"
          ...
          <div>
            {!cartItems[product._id] ? (
              <FaPlus
                ...
                className=" bg-white h-8 w-8 p-2 
            rounded-full shadow-inner cursor-pointer"
              ...
              <div className="bg-white rounded-full flexCenter gap-2 h-8 ">
                ...
                <FaPlus
                  onClick={() => addToCart(product._id)}
                  className="bg-secondary h-6 w-6 p-1 mr-1 cursor-pointer rounded-full"
                />
              </div>
            )}
          </div>

...
const ProductMd = ({ product }) => {
  ...
  return (
    <section className="max-padd-container flex flex-col gap-8 xl:flex-row lg:bg-primary py-4">
      {/* left side */}
      <div className="flex gap-x-2 xl:flex-1 py-5">
        ...
        <div className="max-h-[377px] w-auto flex object-cover">
          <img
            src={product.image}
            alt="bigImg"
      ...
      <div className="flex-col flex xl:flex-[1.5] bg-white px-6 py-2 rounded-xl">
        ...
        <div className="flex gap-4 mb-8 max-w-[555px] flex-wrap">
          ...
          {!cartItems[product._id] ? (
            ...
            <div className="bg-tertiary text-white rounded-sm flexCenter gap-2">
              ...
              />
              <p className="text-white p-2 ">{cartItems[product._id]}</p>
              <FaPlus
                onClick={() => addToCart(product._id)}
        ...
        <p>
          <span className="medium-16 text-tertiary">Category :</span> {product.category} 
        </p>
        <p>
